	...
	\begin{columns}[onlytextwidth]
		\begin{column}{0.45\textwidth}
			\begin{tikzpicture}[scale=0.9,transform shape]
				...
				\draw[thick] (0,0) rectangle ++(5,4) node[pos=0.5,rectangle,fill=white] {synapses};
				...
				\draw[thick] (0,-1) rectangle ++(5,0.5) node[pos=0.5,rectangle,fill=white] {neurons};
	...
	\begin{columns}[onlytextwidth]
		\begin{column}{0.45\textwidth}
			...
			\begin{tikzpicture}[scale=0.6,transform shape]
				...
				\draw (comp.out) to[short,-o] ++(1,0) node[right] {out};
				\draw (5.5,3) to ++(0,-0.5);
			\end{tikzpicture}
		\end{column}
	\end{columns}
