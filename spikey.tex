...
\begin{frame}[fragile]{Synaptic connections}
	...
	\begin{minted}{python}
weight = 15 * pynn.getMinExcWeight()
...
\begin{frame}{Task 3: a synfire chain}
	\begin{center}
		\begin{tikzpicture}
			...
			\node[circle,white,fill=red,text width=0.8cm,align=center] (ex1) at (2.0,0) {\footnotesize\strut \# 1};
			\node[circle,white,fill=red,text width=0.8cm,align=center] (ex2) at (4.0,0) {\footnotesize\strut \# 2};
			\node[circle,white,fill=red,text width=0.8cm,align=center] (ex3) at (6.0,0) {\footnotesize\strut \# 3};
			\node[circle,white,fill=red,text width=0.8cm,align=center] (ex4) at (8.0,0) {\footnotesize\strut \# 4};
			
			\node[circle,white,fill=blue,text width=0.8cm,align=center] (in1) at (2.0,-2) {\footnotesize\strut \# 1};
			\node[circle,white,fill=blue,text width=0.8cm,align=center] (in2) at (4.0,-2) {\footnotesize\strut \# 2};
			\node[circle,white,fill=blue,text width=0.8cm,align=center] (in3) at (6.0,-2) {\footnotesize\strut \# 3};
			\node[circle,white,fill=blue,text width=0.8cm,align=center] (in4) at (8.0,-2) {\footnotesize\strut \# 4};
			...
			\draw[-stealth,thick,blue] (in4) -- (ex4);
		\end{tikzpicture}
	\end{center}
